  ...
  return (
    <Box sx={{ maxWidth: 760, mx: 'auto', px: { xs: 2, md: 4 }, py: 4 }}>
      ...
      <Typography color="text.secondary" sx={{ mb: 4 }}>
        Need help? Check the FAQs below or get in touch with our team directly.
      </Typography>

      {/* Contact cards */}
      <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 5 }}>
        <Paper variant="outlined" sx={{ flex: 1, minWidth: 200, p: 2.5, borderRadius: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
            <PhoneIcon color="primary" fontSize="small" />
            <Typography fontWeight={700}>Phone</Typography>
          </Box>
          <Link href="tel:+61290000000" underline="hover" color="text.primary">
            (02) 9000 0000
          </Link>
        </Paper>
        ...
        <Paper variant="outlined" sx={{ flex: 1, minWidth: 200, p: 2.5, borderRadius: 2 }}>
          ...
          <Link href="mailto:hire@fleetly.com.au" underline="hover" color="text.primary">
            hire@fleetly.com.au
          </Link>
        </Paper>
        ...
        <Paper variant="outlined" sx={{ flex: 1, minWidth: 200, p: 2.5, borderRadius: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary">Mon – Fri: 7 am – 5 pm</Typography>
          <Typography variant="body2" color="text.secondary">Sat: 7 am – 12 pm</Typography>
        </Paper>
      </Box>
      ...
      <Box sx={{ mt: 2 }}>
        {faqs.map((faq) => (
          <Accordion key={faq.q} disableGutters elevation={0} variant="outlined" sx={{ mb: 1, borderRadius: '8px !important', '&:before': { display: 'none' } }}>
